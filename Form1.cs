...
namespace zilelot
{
    public partial class Form1 : Form
    {
        ...
        //TO DO: fanction that check if the zolelet is exsist acording to the player gessing 
        ...
        private void TableSet()
        {
            ...
            for (int j= 1; j <= 10; j++)
            {
                ...
                t_myships2.Controls.Add(new Label { Text = j.ToString() }, 0, j);
                t_opoships.Controls.Add(new Label { Text = j.ToString() }, 0, j);
                t_opoships2.Controls.Add(new Label { Text = j.ToString() }, 0, j);
                for (int k = 1; k <= 10; k++)
                {
